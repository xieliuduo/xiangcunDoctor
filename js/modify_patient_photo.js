...
function send_request() {
    ...
    if (xmlhttp != null) {
        ...
        serverUrl = xs_utils.getApiUrl("/api/common/upload/signature",{"token":patient_edit.uToken});
...
var uploader = new plupload.Uploader({
    ...
    init: {
        ...
        FileUploaded: function(up, file, info) {
            if (info.status == 200) {
                patient_edit.u_avatar = get_uploaded_object_name(file.name);
