...
function send_request() {
    ...
    if (xmlhttp != null) {
        ...
        serverUrl = xs_utils.getApiUrl("/api/common/upload/signature",{"token":ucenter.syToken});
...
var uploader = new plupload.Uploader({
    ...
    init: {
        ...
        FileUploaded: function(up, file, info) {
            if (info.status == 200) {
                ucenter.u_avatar = get_uploaded_object_name(file.name);
                //换头像
                ucenter.modifyUserAvatar();
